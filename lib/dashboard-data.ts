export const nav = {
  admin: [
    ...
    {
      icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5A4.5 4.5 0 003 9.5v8A4.5 4.5 0 017.5 13c1.746 0 3.332.477 4.5 1.253m0-8C13.168 5.477 14.754 5 16.5 5A4.5 4.5 0 0121 9.5v8A4.5 4.5 0 0016.5 13c-1.746 0-3.332.477-4.5 1.253",
      label: "Courses",
